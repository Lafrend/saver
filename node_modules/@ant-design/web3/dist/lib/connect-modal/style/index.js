    ...
    [`${componentCls}-body`]: {
      ...
      [`${componentCls}-main-panel`]: {
        ...
        [`${componentCls}-get-btn`]: {
          background: isDark ? new _tinycolor.TinyColor(token.colorWhite).setAlpha(0.15).toRgbString() : token.colorPrimary,
...
function useStyle(prefixCls) {
  return (0, _useStyle.useStyle)('ConnectModal', token => {
    const isDark = (0, _utils.isDarkTheme)(token);
    const connectModalToken = (0, _internal.mergeToken)(token, {
      selectedBg: isDark ? token.colorWhite : token.colorPrimary,
      selectedColor: token.colorBgContainer,
      hoverBg: new _tinycolor.TinyColor(isDark ? token.colorWhite : token.colorPrimary).setAlpha(0.1).onBackground(token.colorBgContainer).toRgbString(),
      ...
      modalTitleEndColor: new _tinycolor.TinyColor('#000').setAlpha(0.85).onBackground(token.colorWhite).toRgbString(),
      ...
      cardBg: new _tinycolor.TinyColor(token.colorText).setAlpha(0.1).toRgbString(),
