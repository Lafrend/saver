...
var WalletList = function WalletList(props) {
  ...
  var _useContext = useContext(connectModalContext),
    ...
    selectedWallet = _useContext.selectedWallet,
    updatePanelRoute = _useContext.updatePanelRoute;
  var dataSource = useMemo(function () {
    var result = {};
    walletList.forEach(function (wallet) {
      var _wallet$group = wallet.group,
        group = _wallet$group === void 0 ? 'More' : _wallet$group;
      if (!result[group]) {
        result[group] = [];
      }
  ...
  var groupKeys = useMemo(function () {
    return Object.keys(dataSource).sort(groupOrder !== null && groupOrder !== void 0 ? groupOrder : defaultGroupOrder);
  ...
  return /*#__PURE__*/_jsxs("div", {
    className: "".concat(prefixCls, "-wallet-list"),
    children: [contextHolder, groupKeys.map(function (group) {
      return /*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsx("div", {
          ...
          className: "".concat(prefixCls, "-group-content"),
          children: /*#__PURE__*/_jsx(List, {
            ...
            renderItem: function renderItem(item) {
              return /*#__PURE__*/_jsx(List.Item, {
                className: classNames("".concat(prefixCls, "-wallet-item"), {
                  selected: item.key !== undefined ? (selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.key) === item.key : (selectedWallet === null || selectedWallet === void 0 ? void 0 : selectedWallet.name) === item.name
                }),
                onClick: /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                  var _item$hasWalletReady;
                  var hasWalletReady;
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return (_item$hasWalletReady = item.hasWalletReady) === null || _item$hasWalletReady === void 0 ? void 0 : _item$hasWalletReady.call(item);
                      case 2:
                        hasWalletReady = _context.sent;
                        if (!hasWalletReady) {
                          _context.next = 7;
                          break;
                        }
                ...
                children: /*#__PURE__*/_jsxs("div", {
                  ...
                  children: [/*#__PURE__*/_jsx("div", {
                    ...
                    children: typeof item.icon === 'string' || item.icon === undefined ? /*#__PURE__*/_jsx("img", {
                      src: item.icon,
                      alt: item.name
                    }) : item.icon
                  }), /*#__PURE__*/_jsx("div", {
